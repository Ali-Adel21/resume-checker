...
const FileUploader = ({ onFileSelect }: FileUploaderProps) => {
  ...
  return (
    <div className="w-full gradient-border">
      <div {...getRootProps()}>
        <input {...getInputProps()} />
        <div className="space-4 cursor-pointer">
          {file ? (
            <div
            ...
            >
              ...
              <div className="flex items-center space-x-3">
                <div>
                  <span className="text-sm font-medium text-grey-700 truncate max-w-xs">
                    {file.name}
                  </span>
            ...
            <div>
              ...
              <p className="text-sm text-grey-500">PDF (max 20 MB)</p>
            </div>
          )}
        </div>
      </div>
